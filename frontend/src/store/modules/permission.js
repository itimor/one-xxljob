...
export const componentsMap = {
  ...
  brand: () => import('@/views/domain/brand'), // 品牌管理
  domaintype: () => import('@/views/domain/domaintype'), // 域名类型
  domain: () => import('@/views/domain/domain'), // 域名列表

  // boce
  bocenodegroup: () => import('@/views/boce/bocenodegroup'), // 执行器
  xxljob: () => import('@/views/boce/xxljob'), // xxljob列表
  ...
  // notice
  mailbot: () => import('@/views/notice/mailbot'), // mail bot
  tgbot: () => import('@/views/notice/tgbot'), // telegram bot
}
