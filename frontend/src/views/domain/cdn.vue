  ...
  export default {
    ...
    methods: {
      ...
      getList() {
        ...
        cdn.requestGet(this.listQuery).then(response => {
      ...
      createData() {
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            this.loading = true
            cdn.requestPost(this.temp).then(response => {
      ...
      updateData() {
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            this.loading = true
            cdn.requestPut(this.temp.id, this.temp).then(() => {
              this.dialogFormVisible = false
              this.$notify({
                title: '成功',
                message: '更新成功',
      ...
      handleBatchDel() {
        ...
        this.$confirm('是否确定删除?', '提示', {
          ...
          cdn.requestBulkDelete(ids).then(response => {
